...
from ..utils import current_day, current_month_number, current_year, get_worksheet_name
...
def _print_spreadsheet_url(spreadsheet):
    url = "https://docs.google.com/spreadsheets/d/{0}/edit".format(spreadsheet.id)
